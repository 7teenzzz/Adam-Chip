...
<!-- merged from ch18_1_конфигурационный_уровень_инициализация_при_запуске_системы.md -->

# 1. Конфигурационный уровень (инициализация): при запуске системы
загружается кодировка AIIM и базовые параметры транслируются в системный
промпт

<!-- merged from ch19_2_динамический_уровень_взаимодействие_в_процессе_диалога_зна.md -->
