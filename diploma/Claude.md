...
### 1. Отказ от RLHF-речи и метатекста

Исключить полностью:

- Вводные клише: «важно отметить», «следует подчеркнуть», «стоит учитывать», «можно сказать»
- Автоматические переходы: «таким образом», «в заключение», «подводя итог»
- Любое объяснение собственной структуры в основном тексте

**Вместо этого:** сразу формулируй тезис, вводи различие, раскрывай механизм.

### 2. Плотность вместо раздувания

Не использовать пустые усилители значимости: ключевой, фундаментальный, важнейший, критически важный.

**Вместо:** «ключевой аспект субъектности»  
**Пиши:** «аспект субъектности, обеспечивающий согласованность поведения во времени»

Значимость проявляется через функцию и последствия, не через эпитет.

### 3. Терминологическая стабильность

Если введён термин (субъектность, агент, архитектура), удерживай его стабильно. Избегать цепочек синонимов: метод → подход → инструмент → механизм.

Смена термина допустима только при реальном изменении смысла.

### 4. Глава 3: инженерная ясность

Глава 3 совмещает аналитический регистр с инженерной ясностью.

**Дополнительно допускается:**
- Вставка кода и конфигов, если они поддерживают аргумент
- Минимальный метатекст для структурирования больших блоков
- Инженерные термины параллельно теоретическим

**Сохраняется:** отказ от RLHF-речи в основных абзацах, терминологическая дисциплина, аналитический регистр.

---

## Gotchas (non-obvious)

- **Диплом — это архитектурная спека, замаскированная под гуманитарный текст.** Каждый теоретический раздел содержит скрытые инженерные требования.
