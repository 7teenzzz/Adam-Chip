...
## Направление требует серьезных доработок

- Включение в нужный момент предсгенерированного аудио с соответсвующим выражением на китайском
- Продумывание механизма подачи llm данных воспоминаний и выдача инструкции применения
- Продумывание механизма использования llm-кой паттерна воспоминания + опредление оптимального синтаксиса.
...
> Стартовый набор — 7 фраз. Расширять итеративно (целевой объём — 15–20). Ориентир: Ши и короткие философские строки.
