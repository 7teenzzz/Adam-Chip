...
const SCHEMA = [
  ...
  // ── ASR · WhisperX ───────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "reply_noise_gate",   label: "Noise gate в reply (RMS)",   type: "number",
        hint: "1000 · выше стандартного VAD 600 · фильтрует фоновый шум в reply-окне",
  ...
  // ── Audio ─────────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "vad_threshold", label: "Порог RMS (фоновый шум)", type: "number",
        hint: "400–800 · fallback-порог по амплитуде · не используется при активном WebRTC VAD" },
      { key: "webrtc_vad_aggressiveness", label: "WebRTC VAD — агрессивность", type: "number",
        hint: "0–3 · 2 рекомендуется · выше = строже фильтрует тишину и шум · 3 может пропускать тихую речь",
        min: 0, max: 3, step: 1 },
