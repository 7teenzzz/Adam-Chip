...
const SCHEMA = [
  ...
  // ── ASR · WhisperX ───────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      { key: "reply_noise_gate", label: "Reply window — noise gate (RMS)", type: "number",
        hint: "1600 рекомендуется · VAD засчитывает речь только если RMS выше этого порога · ставить выше фонового шума комнаты",
